...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "System control"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Light on"
  #define MAIN_MENU_ITEM_1_GCODE "M118 A1 action:light_on"
  //#define MAIN_MENU_ITEM_1_CONFIRM

  #define MAIN_MENU_ITEM_2_DESC "Light off"
  #define MAIN_MENU_ITEM_2_GCODE "M118 A1 action:light_off"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Restart mainboard"
  #define MAIN_MENU_ITEM_3_GCODE "M997"
  #define MAIN_MENU_ITEM_3_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_4_DESC "Shut down PI"
  #define MAIN_MENU_ITEM_4_GCODE "M118 A1 action:shutdown"
